...
public class StatusLED {
	 ...
	 */
    public void setStateHigh() { greenLights.set(true); }

    /**
	 * Set state to show cube is not in the intake (red).
	 */
    public void setStateLow() { redLights.set(true); }
	 ...
	 * @param lightType
	 */
    public void stopPulse(Solenoid lightType) { lightType.set(false); }

    /**
	 * Set state of robot to brownout (rapid blinking red).
	 */
    public void setStateBrownout() { redLights.pulse(10); }
}