...
public class OI {
    ...
    public static final Button SECONDARY_LEFT_JOYSTICK_BUTTON =
        new JoystickButton(secondaryController, JOYSTICK_LEFT_CLICK);
    public static final Button SECONDARY_RIGHT_JOYSTICK_BUTTON =
        new JoystickButton(secondaryController, JOYSTICK_RIGHT_CLICK);
