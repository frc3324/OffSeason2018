...
abstract public class MetroSubsystemTalon extends Subsystem {

    public static Encoder[] encoders = new Encoder[4];
    private static final EncodingType ENCODING_TYPE = EncodingType.k4X;
    ...
    public WPI_TalonSRX frontRightMotor, backRightMotor, backLeftMotor, frontLeftMotor;
    public DifferentialDrive mDrive;

    public MetroSubsystemTalon() {}
    /*
     *     For use if 2 encoders are needed
     *         */
    public MetroSubsystemTalon(int leftEncoderPortA, int leftEncoderPortB, int rightEncoderPortA, int rightEncoderPortB,
